...
@section('title', 'Order placed – '.site_name())
  ...
  <div class="col-lg-8">
    <div class="card gadget-card border-secondary mb-4">
      <div class="card-body p-4 text-center">
        ...
        <h1 class="h4 mb-2">Thank you for your order</h1>
        ...
        <div class="bg-black bg-opacity-25 rounded p-3 mb-3 text-start">
        ...
        <div class="bg-black bg-opacity-25 rounded p-3 mb-4">
        ...
        <div class="d-flex flex-wrap justify-content-center gap-2">
          <a href="{{ $invoiceUrl }}" class="btn btn-primary">Print invoice</a>
          @auth
