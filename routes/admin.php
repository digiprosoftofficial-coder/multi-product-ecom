...
Route::middleware(['auth', 'role:super_admin|store_owner|admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('owner.access:site_setting')->group(function () {
        ...
        Route::get('product-page', [\App\Http\Controllers\Admin\PageController::class, 'product'])->name('product-page.index');
        Route::put('product-page', [\App\Http\Controllers\Admin\PageController::class, 'updateProduct'])->name('product-page.update');
    ...
    Route::middleware('owner.access:settings')->group(function () {
        Route::get('settings', [SettingsController::class, 'index'])->name('settings.index');
        Route::put('settings', [SettingsController::class, 'update'])->name('settings.update');
    });

    Route::middleware('role:super_admin|admin')->group(function () {
        Route::get('owner-access', [\App\Http\Controllers\Admin\OwnerAccessController::class, 'index'])->name('owner-access.index');
        Route::put('owner-access', [\App\Http\Controllers\Admin\OwnerAccessController::class, 'update'])->name('owner-access.update');
